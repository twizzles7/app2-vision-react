...
const App: React.FC = () => {
  ...
  const handleSubmit = async (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    // responses
   //mbti   
      "you are an expert person analyzer. you are an expert person analyzer. guess the MBTI of this person. 
      ...
      the second part is: one up to three bullet points that highlight why this person is that particular MBTI profile.",
